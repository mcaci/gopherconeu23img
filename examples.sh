...
go run main.go -o examples/talk3.png -figlet banner -l 5000 -h 1000 Gentle Introduction To eBPF
go run main.go -o examples/talk4.png -fontSize=48 -figlet larry3d -bgHex 0xc9c -fgHex 0x000 Go Right Ahead! Simple Hacks To Cut Memory Usage by 80%
...
go run main.go -o examples/talk6.gif -figlet computer -alt -bgHex 0xabc -fgHex 0x000 API Optimization Tale: Monitor, Fix and Deploy
go run main.go -o examples/talk7.gif -figlet isometric3 -alt -bgHex 0x500 -fgHex 0xeee Coffee Break
go run main.go -o examples/talk8.gif -figlet smkeyboard -banner Panel With the Go Team